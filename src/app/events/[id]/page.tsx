...
export default function PublicEventPage({
  ...
  return (
    <div className="min-h-screen bg-[#042F2E] gallery-protected">
      {/* Header sticky */}
      <header className="sticky top-0 z-40 bg-[#FFFFFF]/95 backdrop-blur-sm border-b border-[#E2E8F0]">
      ...
      <div className="relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-start">
                {event.logoImage && (
                  <div className="relative w-10 h-10 md:w-12 md:h-12 rounded-lg overflow-hidden border border-white/40 flex-shrink-0 shadow-lg">
                    <Image src={event.logoImage} alt="Logo" fill className="object-contain bg-[#FFFFFF]" />
                  </div>
                )}
        ...
        {showAlertModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setShowAlertModal(false)}>
            <div className="bg-[#FFFFFF] rounded-2xl shadow-2xl max-w-sm w-full p-6 border border-[#E2E8F0]" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="-mt-14 relative z-10 px-4">
        <Card className="max-w-2xl mx-auto bg-[#FFFFFF] shadow-2xl rounded-3xl border border-[#E2E8F0]">
          <CardContent className="p-5 md:p-8">
            ...
            <form onSubmit={handleSearch} className="mt-4">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 text-lg h-12 md:h-14 rounded-xl border-[#E2E8F0] bg-[#F1F5F9] text-gray-900 placeholder:text-gray-500 focus:border-emerald focus:ring-emerald"
                />
                <Button
                  type="submit"
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-3">
              <label className="cursor-pointer">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[#E2E8F0] text-xs text-gray-500 hover:border-emerald hover:text-emerald transition-colors bg-[#F1F5F9] hover:bg-emerald/5">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <button type="button" onClick={openCamera} className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[#E2E8F0] text-xs text-gray-500 hover:border-emerald hover:text-emerald transition-colors bg-[#F1F5F9] hover:bg-emerald/5">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" />
                </svg>
              ...
              {event.runnerCount > 0 && (
                <button type="button" onClick={() => searchInputRef.current?.focus()} className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[#E2E8F0] text-xs text-gray-500 hover:border-emerald hover:text-emerald transition-colors bg-[#F1F5F9] hover:bg-emerald/5">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-start justify-between mb-6 gap-4">
            <div className="flex-1">
              {searchResult.runner && (
                <div className="bg-[#FFFFFF] rounded-xl p-4 mb-3 border-l-4 shadow-sm border border-[#E2E8F0]" style={{ borderLeftColor: primaryColor }}>
          ...
          {displayPhotos.length > 0 && (
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
              {displayPhotos.map((photo, index) => (
                <div
                  key={photo.id}
                  className="group relative bg-[#FFFFFF] rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer border border-[#E2E8F0]"
                    ...
                    <button
                      ...
                      className={`absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center transition-colors z-10 ${
                        favorites.has(photo.id)
                          ...
                          : "bg-[#FFFFFF]/80 text-muted-foreground hover:bg-[#FFFFFF]"
                      }`}
                    >
