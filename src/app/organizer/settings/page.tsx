      ...
      <div className="max-w-2xl space-y-6">
          ...
          <CardContent>
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald to-emerald-600 flex items-center justify-center text-white text-xl font-bold shadow-emerald">
                  {session?.user?.name
                    ?.split(" ")
                    .map((n) => n[0])
                    .join("")
        ...
        <Card className="bg-white border-0 shadow-card rounded-xl">
          <CardHeader>
            ...
            <CardDescription className="text-gray-500">Parrainez des organisateurs et recevez des crédits gratuits</CardDescription>
          </CardHeader>
          <CardContent>
            <ReferralCard />
          </CardContent>
