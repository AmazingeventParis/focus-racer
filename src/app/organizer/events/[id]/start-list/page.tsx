          ...
          <CardContent className="space-y-4">
            ...
            {preview.length > 0 && (
              <div className="space-y-4">
                ...
                <div className="border border-[#E2E8F0] rounded-xl overflow-hidden max-h-64 overflow-auto">
                  <Table>
                    <TableHeader>
                      <TableRow>
            ...
            {entries.length === 0 ? (
              ...
              <div className="space-y-4">
                <Input
                  ...
                  className="max-w-sm"
                />
                <div className="border border-[#E2E8F0] rounded-xl overflow-hidden max-h-96 overflow-auto">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead>Dossard</TableHead>
