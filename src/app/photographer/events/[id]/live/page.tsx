      ...
      <header className="bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <Link href={`/photographer/events/${id}`}>
            <Button variant="outline" size="sm" className="text-white/70 border-slate-200 hover:bg-white/5">
          ...
          <Card className="bg-white border-slate-200 rounded-2xl">
            ...
            <CardContent>
              <div
                ...
                className="border-2 border-dashed border-slate-200 rounded-xl p-12 text-center hover:border-emerald transition-colors cursor-pointer"
