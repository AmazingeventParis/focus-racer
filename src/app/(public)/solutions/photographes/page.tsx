...
export default function SolutionsPhotographesPage() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ═══════════ HERO ═══════════ */}
      <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-[#042F2E]">
        <div className="absolute inset-0 bg-[url('/hero-bg.png')] bg-center bg-cover bg-no-repeat opacity-50 pointer-events-none" />
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-[#10B981] rounded-full blur-[150px]" />
          <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-[#059669] rounded-full blur-[120px]" />
        </div>
      ...
      {/* ═══════════ GOLDEN TIME ═══════════ */}
      <section id="golden-time" data-reveal className="py-20 md:py-28 bg-gray-50">
        <div className="container mx-auto px-4">
