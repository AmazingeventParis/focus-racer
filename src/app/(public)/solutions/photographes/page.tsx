    ...
    <main className="bg-white">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-white">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-[#059669] rounded-full blur-[150px]" />
          <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-[#F97316] rounded-full blur-[120px]" />
        </div>
