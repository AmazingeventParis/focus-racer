  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button:
          "h-9 w-9 p-0 font-normal inline-flex items-center justify-center rounded-md hover:bg-[#059669]/10 hover:text-[#059669] transition-colors",
        selected:
          "bg-emerald-500 text-white hover:bg-emerald-600 focus:bg-emerald-600 rounded-md",
        today: "bg-neon-card text-[#059669] font-bold",
        outside: "text-muted-foreground opacity-50",
        disabled: "text-muted-foreground opacity-50",
        range_middle: "bg-[#059669]/10 text-[#059669] rounded-none",
