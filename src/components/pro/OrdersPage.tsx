...
export type { ProRole, OrderRow } from "./orders-csv";

// ---------------------------------------------------------------------------
// Local-only types (not needed in the pure helper)
// ---------------------------------------------------------------------------
...
export default function OrdersPage({ role }: OrdersPageProps) {
  ...
  const handleExportCSV = () => {
    const csv = buildOrdersCsv(sortedOrders, role);
    ...
    <div className="p-4 md:p-8 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button
          ...
          variant="outline"
          className="border-[#E2E8F0] text-gray-400 hover:bg-[#F1F5F9] rounded-lg"
        ...
        <Card className="bg-white border-0 shadow-card rounded-xl mb-6">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="h-5 bg-[#F1F5F9] rounded-full overflow-hidden flex">
                <div
                ...
                {dailyTrend.map((d) => (
                  <div key={d.date} className="flex-1 flex flex-col items-center group relative">
                    ...
                    <div className="absolute bottom-full mb-2 hidden group-hover:block z-10">
                      <div className="bg-[#F1F5F9] text-slate-900 text-xs rounded-lg px-2.5 py-1.5 whitespace-nowrap shadow-lg border border-[#E2E8F0]">
          ...
          <div className="flex flex-col md:flex-row gap-3 items-end">
            <div className="flex-1 min-w-0">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 bg-[#F1F5F9] border-[#E2E8F0] text-slate-900 rounded-lg"
                />
              </div>
            </div>
            <div className="w-full md:w-48">
              ...
              <Select value={eventFilter} onValueChange={setEventFilter}>
                <SelectTrigger className="bg-[#F1F5F9] border-[#E2E8F0] text-slate-900 rounded-lg">
            ...
            <div className="w-full md:w-40">
              ...
              <input
                ...
                className="flex h-10 w-full rounded-lg border border-[#E2E8F0] bg-[#F1F5F9] px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald/20 focus:border-emerald"
              />
            </div>
            <div className="w-full md:w-40">
      ...
      <Card className="bg-white border-0 shadow-card rounded-xl">
        ...
        <CardContent>
          {isLoading ? (
            ...
            <>
              <div className="hidden md:grid grid-cols-12 gap-3 px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-[#E2E8F0] mb-2">
              ...
              <div className="space-y-2">
                {sortedOrders.map((order) => {
                  ...
                  return (
                    <div
                      key={order.id}
                      className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-3 p-4 rounded-xl bg-[#F1F5F9] hover:bg-[#FFFFFF] transition-all duration-200 items-center"
                    >
