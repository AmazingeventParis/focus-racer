  ...
  return (
    <aside className="w-64 gradient-navy text-white min-h-screen flex flex-col">
      ...
      <div className="p-4">
        <Button
          variant="ghost"
          className="w-full justify-start gap-3 text-navy-200 hover:text-white hover:bg-white/5 rounded-xl"
