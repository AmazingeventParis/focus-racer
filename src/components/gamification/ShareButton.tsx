    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute bottom-full mb-2 right-0 z-50 bg-white rounded-xl shadow-lg border border-slate-200 py-1 min-w-[180px]">
            <button
              onClick={handleCopyLink}
              className="w-full px-4 py-2 text-left text-sm text-gray-500 hover:bg-slate-100 flex items-center gap-2"
            >
              {copied ? (
                <>
