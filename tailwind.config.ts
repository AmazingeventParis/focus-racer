  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'emerald': '0 0 20px rgba(8, 145, 178, 0.3)',
        'teal': '0 0 20px rgba(8, 145, 178, 0.25)',
        'neon-glow': '0 0 30px rgba(8, 145, 178, 0.2)',
        'neon-purple': '0 0 30px rgba(192, 132, 252, 0.15)',
      },
      backgroundImage: {
        'gradient-teal': 'linear-gradient(180deg, #111A3A 0%, #070B1F 100%)',
        'gradient-emerald': 'linear-gradient(135deg, #0891B2 0%, #38BDF8 100%)',
        'gradient-hero': 'linear-gradient(135deg, #111A3A 0%, #070B1F 100%)',
        'gradient-runner': 'linear-gradient(180deg, #070B1F 0%, #111A3A 100%)',
        'gradient-neon': 'linear-gradient(135deg, #0891B2, #C084FC)',
